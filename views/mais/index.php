<style>
    .mais-link {
        ...
        <div class="btn-groupo mgb-10">
            <a href="<?php echo ROOT_URL; ?>mais/index/distrito" class="center-t btn btn-secondary mb-4 ">Bairros e Distritos</a>
            <a href="<?php echo ROOT_URL; ?>mais/index/municipio" class="center-t btn btn-secondary mb-4 ">Municipios e Provincias</a>
            <a href="<?php echo ROOT_URL; ?>mais/index/categorias" class="center-t btn btn-secondary mb-4 ">Categorias</a>
