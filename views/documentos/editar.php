...
<style>
    ...
    <h1 class="titulo--normal">Editar Documento</h1>
    ...
    <form method="POST" enctype="multipart/form-data" class="">
        ...
        <!-- Informações do proprietário -->
            ...
            <a class="caixa-info__botao  btn btn-primary mgt-10 " id="add-campo">Editar Número</a>
            ...
            <div class="caixa-info br-25 mbg-20">
                ...
                <div class="caixa-info__item">
                    ...
                    <div class="caixa-info__descricao caixa-info__grupo-img ">
                        ...
                        <input id="filetype" type="file" name="editarDocumentoFotoFrente[]" class="file-chooser" hidden />
                        ...
                        <input id="filetype2" type="file" name="editarDocumentoFotoTraz[]" class="file-chooser2" hidden />
                    </div>
                </div>
                <script>
        ...
        <a  class="  btn btn-primary mgt-10 " id="add-documentos">Editar Documento</a>
        <br>
        <div class="btn-grupo mgt-10">
        <button type="submit" name="submit" value="Editar" type="submit" name="submit" value="Editar" class="  btn btn-success ">Publicar Documentos</button>
