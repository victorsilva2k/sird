  ...
  <div class="row gx-5">
    ...
    <div class="col">
        ...
        <ul class="pagination justify-content-end">
            <li class="page-item">
            <a class="page-link" href="<?php echo ROOT_URL . "documentos/recebidos/" .($this->param == NULL OR $this->param == "") ?  $this->param - 1: "1" ;  ?>">Anterior</a>
            </li>
            ...
            <a class="page-link" href="<?php echo ROOT_URL . "documentos/recebidos/" . ($this->param + 1); ?>">Próximo</a>
            </li>
        </ul>
        </nav>
    </div>
